...
export function SocialButtons({ className }: SocialButtonsProps) {
  return (
    <div className={`social-buttons-wrapper ${className || ''}`}>
      <div className="social-container">
        <ul className="social-list">
          <li>
            <a href="https://discord.gg/HYsr4gZjj6" aria-label="Discord" className="social-link discord" target="_blank" rel="noopener noreferrer">
              <span className="icon">
                <DiscordIcon />
              </span>
            </a>
